...
training_data_file_name = os.path.join(home_dir, 'Projects', project_name, data_set + '.npy')
testing_data_file_name = os.path.join(home_dir, 'Projects', project_name, test_set + '.npy')
print('#'*50)
...
def load_train_data():
    ...
    ## change the dim of data
    train_data = train_data.transpose(0, 3, 1, 2)
    train_data_input = train_data_input.transpose(0, 3, 1, 2)
